"""URL routes for the feed app's schedule and realtime endpoints."""
...
urlpatterns = [
    ...
    path("schedule/feed.zip", views.schedule, name="schedule"),
    ...
    path(
        "realtime/trip_updates.json", views.trip_updates_json, name="trip_updates_json"
    ),
